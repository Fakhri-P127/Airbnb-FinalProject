...
{
    public partial class CreatedDatabaseWithEverything : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingProtectionGuarantee = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    CheckInGuarantee = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    GetWhatYouBookedGuarantee = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    FullDaySafetyLine = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    FindMore = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullRefund = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    PartialRefund = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    NoRefund = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDisplayed = table.Column<bool>(type: "bit", nullable: true, defaultValue: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilPicture = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxNightCount = table.Column<byte>(type: "tinyint", nullable: false),
                    ...
                    PropertyGroupId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PropertyTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PrivacyTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AirCoverId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuestScore = table.Column<float>(type: "real", nullable: false),
                    HostId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CleanlinessScore = table.Column<float>(type: "real", nullable: false),
                    CommunicationScore = table.Column<float>(type: "real", nullable: false),
                    CheckInScore = table.Column<float>(type: "real", nullable: false),
                    AccuracyScore = table.Column<float>(type: "real", nullable: false),
                    LocationScore = table.Column<float>(type: "real", nullable: false),
                    ValueScore = table.Column<float>(type: "real", nullable: false),
                    AppUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReservationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HostId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuestReviews_AppUserId",
                table: "GuestReviews",
                column: "AppUserId");
