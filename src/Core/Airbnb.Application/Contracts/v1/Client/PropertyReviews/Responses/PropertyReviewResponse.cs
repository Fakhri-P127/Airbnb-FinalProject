...
namespace Airbnb.Application.Contracts.v1.Client.PropertyReviews.Responses
{
    public class PropertyReviewResponse : BaseResponse
    {
        ...
        public AppUserInPropertyReviewResponse AppUser { get; set; }
        // guestin etdiyi reservation deki prop Id bunla ust uste dushurse icaze ver
        //public Guid PropertyId { get; set; }
        //public Property Property { get; set; }
        public ReservationInPropertyReviewResponse Reservation { get; set; }
        // bunlari sonda duzelt
