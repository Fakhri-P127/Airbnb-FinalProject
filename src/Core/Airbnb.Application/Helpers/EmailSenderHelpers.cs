...
namespace Airbnb.Application.Helpers
{
    public static class EmailSenderHelpers
    {
            ...
            IEmailSender _emailSender, FormFileCollection files=null)
        {
            ...
            MessageResponse message = new(new string[] { user.Email, "efendiyev1902@gmail.com" }, subject, content, files);
            await _emailSender.SendEmailAsync(message);
        }
         ...
         IEmailSender _emailSender)
        {
            ...
            MessageResponse message = new(new string[] { user.Email, "efendiyev1902@gmail.com" }, subject, content, null);
            await _emailSender.SendEmailAsync(message);
        }
    }
}
